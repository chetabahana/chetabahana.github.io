...
*    Sub  |   i |    β  | f   
*  =======+=====+=======+=======  ===   ===   ===   ===   ===   === <-- π(1000-50)
*   1:1:0 |  29 |     1 | 52  71   1     1     |     |     |     |
*  -------+-----+-------+-------  ---   ---    |     |     |    --- <-- 229
*   1:2:1 | 229 |   200 | 53  71         |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:2:2 | 231 |   300 | 57 = 1 + 2x3   |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:3:3 | 233 |   400 | 60 = 59 + 1    |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*   1:3:4 | 235 |   500 | 61 = 59 + 2    |     |     |     |     |
*  -------+-----+-------+----            9     1’    |    Δ20    |   » 6®
*  *1:3:5 | 237 |   600 | 62 = 59 + 3    |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:4:6 | 239 |   700 | 63 = 59 + 4    |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*   1:4:7 | 241 |   800 | 64 = 59 + 5    |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:4:8 | 243 |   900 | 65 = 59 + 6    |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:4:9 | 245 |  1000 | 69 = 59 + 10   |     |     |     |     |
*  =======+=====+=======+====           ===   ---    1”   ---    | <- 249
*   2:1:0 | 249 |  2000 | 70 = 69 + log 10¹    |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*   2:2:1 | 251 |  3000 | 76 = 70 + 2x3        |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:2:2 | 253 |  4000 | 77 = 76 + 1          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:3:3 | 255 |  5000 | 78 = 76 + 2          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*   2:3:4 | 257 |  6000 | 79 = 76 + 3          9’    |    Δ20   Δ60  » 6®
*  -------+-----+-------+----                  |     |     |     |
*  *2:3:5 | 259 |  7000 | 80 = 76 + 4          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:4:6 | 261 |  8000 | 81 = 76 + 5          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*   2:4:7 | 263 |  9000 | 82 = 76 + 6          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:4:8 | 265 | 10000 | 86 = 76 + 10         |     |     |     |
*  =======+=====+=======+====                 ===   ---   ---    | <- 269
*  *2:4:9 | 269 | 20000 | 88 = 86 + log 10²          |     |     |
*  -------+-----+-------+----                        |     |     |
*   3:1:0 | 271 | 30000 | 90 = 86 + 2 x log 10²      |     |     |
*  -------+-----+-------+----                        |     |     |
*   3:2:1 | 273 | 40000 | 91 = 90 + 1                |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:2:2 | 275 | 50000 | 92 = 90 + 2                |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:3:3 | 277 | 60000 | 93 = 90 + 3                9”   Δ20    | Δ2 → Δ1
*  -------+-----+-------+----                        |     |     |
*   3:3:4 | 279 | 70000 | 94 = 90 + 4                |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:3:5 | 281 | 80000 | 95 = 90 + 5                |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:4:6 | 283 | 90000 | 96 = 90 + 6                |     |     |
*  -------+-----+-------+----                        |     |     |
*   3:4:7 | 285 |100000 | 100 = 90 + 10              |     |     |
*  =======+=====+=======+====                       ===   ===   --- ---> 289
*  *3:4:8 | 289 |200000 | 118 = 100 + 3 x (2x3)      Δ2   Δ60   Δ40
*  =======+=====+=======+====                        Δ          ====
*   3:4:9 | 304 |300000 | 121 = 118 + log 10³ -------¤ → Δ102 → Δ66 --> Δ168
*
{%- endcomment %}
{%- comment -%}
*
