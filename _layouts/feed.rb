...
*  *2:3:3 | 14 |  50 | 28 = 26 + 2          |     |     |     |
*  -------+----+-----+----                  |     |     |     |
*   2:3:4 | 15 |  60 | 29 = 26 + 3          9’    |   Δ200  Δ600  » 6®
*  -------+----+-----+----                  |     |     |     |
*  *2:3:5 | 16 |  70 | 30 = 26 + 4          |     |     |     |
*  -------+----+-----+----                  |     |     |     |
*  *2:4:6 | 17 |  80 | 31 = 26 + 5          |     |     |     |
...
*  -------+----+-----+----                        |     |     |
*  *3:3:3 | 24 | 600 | 43 = 40 + 3                9”  Δ300    | Δ100 → Δ10
*  -------+----+-----+----                        |     |     |
...
*   1:2:1 |  29 |    20 | 71  71         |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:2:2 |  39 |    30 | 161 = 1 + 2x3  |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:3:3 |  49 |    40 | 231 = 59 + 1   |     |     |     |     |  
*  -------+-----+-------+----            |     |     |     |     |
*   1:3:4 |  59 |    50 | 231 = 59 + 2   |     |     |     |     |
*  -------+-----+-------+----            9     1’    |    Δ100   |    » 6®
*  *1:3:5 |  69 |    60 | 231 = 59 + 3   |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:4:6 |  79 |    70 | 271 = 59 + 4   |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*   1:4:7 |  89 |    80 | 231 = 59 + 5   |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:4:8 |  99 |    90 | 231 = 59 + 6   |     |     |     |     |
*  -------+-----+-------+----            |     |     |     |     |
*  *1:4:9 | 109 |   100 | 195 = 59 + 10  |     |     |     |     |
*  =======+=====+=======+====           ===   ---    1”   ---    | <-- 129
*   2:1:0 | 129 |   200 | 14 = 69 + log 10¹    |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*   2:2:1 | 139 |   300 | 109 = 70 + 2x3       |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:2:2 | 149 |   400 | 69 = 76 + 1          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:3:3 | 159 |   500 | 109 = 76 + 2         |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*   2:3:4 | 169 |   600 | 71 = 76 + 3          9’    |   Δ200  Δ600  » 6®
*  -------+-----+-------+----                  |     |     |     |
*  *2:3:5 | 179 |   700 | 71 = 76 + 4          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:4:6 | 189 |   800 | 71 = 76 + 5          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*   2:4:7 | 199 |   900 | 71 = 76 + 6          |     |     |     |
*  -------+-----+-------+----                  |     |     |     |
*  *2:4:8 | 209 |  1000 | 70 = 76 + 10         |     |     |     |
*  =======+=====+=======+====                 ===   ---   ---    | <-- 229
*  *2:4:9 | 229 |  2000 | 90 = 86 + log 10²          |     |     |
*  -------+-----+-------+----                        |     |     |
*   3:1:0 | 239 |  3000 | 48 = 86 + 2 x log 10²      |     |     |
*  -------+-----+-------+----                        |     |     |
*   3:2:1 | 249 |  4000 | 278 = 90 + 1               |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:2:2 | 259 |  5000 | 48 = 90 + 2                |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:3:3 | 269 |  6000 | 48 = 90 + 3                9”  Δ300    | Δ20 → Δ2
*  -------+-----+-------+----                        |     |     |
*   3:3:4 | 279 |  7000 | 48 = 90 + 4                |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:3:5 | 289 |  8000 | 48 = 90 + 5                |     |     |
*  -------+-----+-------+----                        |     |     |
*  *3:4:6 | 299 |  9000 | 100 = 90 + 6               |     |     |
*  -------+-----+-------+----                        |     |     |
*   3:4:7 | 309 | 10000 | 50 = 90 + 10               |     |     |
*  =======+=====+=======+====                       ===  ====  ---- ---> 329
*  *3:4:8 | 329 | 20000 | 51 = 100 + 3 x (2x3)      10³  Δ600  Δ300
*  =======+=====+=======+====                        Δ         ====
*   3:4:9 | 349 | 30000 | 52 = 118 + log 10³ ------¤ → Δ100/50 → Δ2 --> Δ102
*
*  Reference:
...
*    Sub  |   i |    β  | f   
*  =======+=====+=======+=======   ===   ===   ===   ===   ===   === <-- π(1000-50)
*   1:1:0 | 329 |   100 | 102  71   1     1     |     |     |     |
*  -------+-----+-------+-------   ---   ---    |     |     |    --- <-- 229
*   1:2:1 | 339 |   200 | 103  71         |     |     |     |     |
*  -------+-----+-------+----             |     |     |     |     |
*  *1:2:2 | 349 |   300 | 107 = 1 + 2x3   |     |     |     |     |
*  -------+-----+-------+----             |     |     |     |     |
*  *1:3:3 | 359 |   400 | 110 = 59 + 1    |     |     |     |     |
*  -------+-----+-------+----             |     |     |     |     |
*   1:3:4 | 369 |   500 | 111 = 59 + 2    |     |     |     |     |
*  -------+-----+-------+----             9     1’    |    Δ20    |   » 6®
*  *1:3:5 | 379 |   600 | 112 = 59 + 3    |     |     |     |     |
*  -------+-----+-------+----             |     |     |     |     |
*  *1:4:6 | 389 |   700 | 113 = 59 + 4    |     |     |     |     |
*  -------+-----+-------+----             |     |     |     |     |
*   1:4:7 | 399 |   800 | 114 = 59 + 5    |     |     |     |     |
*  -------+-----+-------+----             |     |     |     |     |
*  *1:4:8 | 409 |   900 | 115 = 59 + 6    |     |     |     |     |
*  -------+-----+-------+----             |     |     |     |     |
*  *1:4:9 | 419 |  1000 | 119 = 59 + 10   |     |     |     |     |
*  =======+=====+=======+====            ===   ---    1”   ---    | <- 249
*   2:1:0 | 429 |  2000 | 120 = 69 + log 10¹    |     |     |     |
*  -------+-----+-------+----                   |     |     |     |
*   2:2:1 | 439 |  3000 | 126 = 70 + 2x3        |     |     |     |
*  -------+-----+-------+----                   |     |     |     |
*  *2:2:2 | 449 |  4000 | 127 = 76 + 1          |     |     |     |
*  -------+-----+-------+----                   |     |     |     |
*  *2:3:3 | 459 |  5000 | 128 = 76 + 2          |     |     |     |
*  -------+-----+-------+----                   |     |     |     |
*   2:3:4 | 469 |  6000 | 129 = 76 + 3          9’    |    Δ20   Δ60  » 6®
*  -------+-----+-------+----                   |     |     |     |
*  *2:3:5 | 479 |  7000 | 130 = 76 + 4          |     |     |     |
*  -------+-----+-------+----                   |     |     |     |
*  *2:4:6 | 489 |  8000 | 131 = 76 + 5          |     |     |     |
*  -------+-----+-------+----                   |     |     |     |
*   2:4:7 | 499 |  9000 | 132 = 76 + 6          |     |     |     |
*  -------+-----+-------+----                   |     |     |     |
*  *2:4:8 | 509 | 10000 | 136 = 76 + 10         |     |     |     |
*  =======+=====+=======+====                  ===   ---   ---    | <- 269
*  *2:4:9 | 519 | 20000 | 138 = 86 + log 10²          |     |     |
*  -------+-----+-------+----                         |     |     |
*   3:1:0 | 529 | 30000 | 140 = 86 + 2 x log 10²      |     |     |
*  -------+-----+-------+----                         |     |     |
*   3:2:1 | 539 | 40000 | 141 = 90 + 1                |     |     |
*  -------+-----+-------+----                         |     |     |
*  *3:2:2 | 549 | 50000 | 142 = 90 + 2                |     |     |
*  -------+-----+-------+----                         |     |     |
*  *3:3:3 | 559 | 60000 | 143 = 90 + 3                9”   Δ20    | Δ2 → Δ1
*  -------+-----+-------+----                         |     |     |
*   3:3:4 | 569 | 70000 | 144 = 90 + 4                |     |     |
*  -------+-----+-------+----                         |     |     |
*  *3:3:5 | 579 | 80000 | 145 = 90 + 5                |     |     |
*  -------+-----+-------+----                         |     |     |
*  *3:4:6 | 589 | 90000 | 146 = 90 + 6                |     |     |
*  -------+-----+-------+----                         |     |     |
*   3:4:7 | 599 |100000 | 150 = 90 + 10               |     |     |
*  =======+=====+=======+====                        ===   ===   --- ---> 289
*  *3:4:8 | 618 |200000 | 168 = 100 + 3 x (2x3)       Δ2   Δ60   Δ40
*  =======+=====+=======+====                                   ====
